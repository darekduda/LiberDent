...
namespace LiberDent.PortalWWW.Views.Manage
{
    public static class ManageNavPages
    {
        ...
        public static string Wizyty => "Wizyty";
        ...
        public static string WizytyNavClass(ViewContext viewContext) => PageNavClass(viewContext, Wizyty);
